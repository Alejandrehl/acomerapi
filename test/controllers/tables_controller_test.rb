...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { branch_id: @table.branch_id, description: @table.description, state: @table.state } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { branch_id: @table.branch_id, description: @table.description, state: @table.state } }
